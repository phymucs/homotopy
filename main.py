...
best_prec1 = 0
global val_acc, train_acc, train_loss, val_loss
...
def main():
    ...
    csvfile = open('./traditional_result/'+args.arch+'/train_loss.csv' , 'a+', newline='')
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(train_loss)
    csvfile.close()
    csvfile = open('./traditional_result/'+args.arch+'/train_acc.csv' , 'a+', newline='')
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(train_acc)
    csvfile.close()
    csvfile = open('./traditional_result/'+args.arch+'/val_loss.csv' , 'a+', newline='')
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(val_loss)
    csvfile.close()
    csvfile = open('./traditional_result/'+args.arch+'/val_acc.csv' , 'a+', newline='')
    writer = csv.writer(csvfile, delimiter=',')
